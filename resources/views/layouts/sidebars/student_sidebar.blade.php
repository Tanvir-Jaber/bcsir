            ...
            <div class="main-menu">
                ...
                <ul class="side-menu">
                    ...
                    <li class="slide">
                        <a class="side-menu__item" data-bs-toggle="slide" href="javascript:void(0);">
                            <i class="feather feather-home  sidemenu_icon"></i>
                            <span class="side-menu__label">My Teachers</span></a>
                    </li>
                    ...
                    <li class="slide ">
                        ...
                        <ul class="slide-menu">
                            ...
                            <li><a href="javascript:void(0);" class="slide-item">My Remarks & HW</a></li>
                            <li><a href="javascript:void(0);" class="slide-item">Test Result</a></li>
                        </ul>
                    </li>
                    <li class="slide">
                        <a class="side-menu__item" data-bs-toggle="slide" href="javascript:void(0);">
