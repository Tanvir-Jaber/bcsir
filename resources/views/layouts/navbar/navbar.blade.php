    ...
    <div class="container-fluid main-container">
        <div class="d-flex">
            <a class="header-brand" href="index.html">
                <!-- <img src="../assets/images/brand/logo.png" class="header-brand-img desktop-lgo" alt="BCSIR">
                <img src="../assets/images/brand/logo-white.png" class="header-brand-img dark-logo" alt="BCSIR"> -->
                <img src="{{ asset('assets/images/brand/favicon.png') }}" class="header-brand-img mobile-logo"
                    alt="BCSIR">
                <!-- <img src="../assets/images/brand/favicon1.png" class="header-brand-img darkmobile-logo" alt="BCSIR"> -->
            </a>
                        ...
                        <div class="d-flex ms-auto">
                            ...
                            <div class="dropdown profile-dropdown">
                                <a href="javascript:void(0);" class="nav-link pe-1 ps-0 leading-none"
                                    ...
                                    <span>
                                        <img src="{{ asset('assets/images/users/avatar5.jpg') }}" alt="img"
                                ...
                                <div class="dropdown-menu dropdown-menu-end dropdown-menu-arrow animated">
                                    <div class="p-3 text-center border-bottom">
                                        <a href="javascript:void(0)"
                                            class="text-center user pb-0 font-weight-bold">{{ auth()->user()->first_name }}
                                            {{ auth()->user()->last_name }}</a>
                                        <p class="text-center user-semi-title">{{ getUserTypeName() }}</p>
                                    </div>
